...
Используйте /help для просмотра команд\\."""
    ...
    _HELP_SECTIONS = {
        ...
        "help_roadmap": (
            "🗺 *Сервер с нуля — дорожная карта*\n\n"
            "Порядок развёртывания протоколов на чистом VPS\\.\n"
            "Копируйте команды и вставляйте по шагам\\.\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "*1\\. VLESS\\-Reality \\(основной\\)*\n"
            "`/vless\\_sync`  — автонастройка всего\n"
            "`/vless\\_add\\_client phone`\n"
            "`/vless\\_qr phone`\n\n"
            "*2\\. Hysteria2 \\(UDP/QUIC\\)*\n"
            "`/hy2\\_install`\n"
            "`/hy2\\_set\\_server IP`\n"
            "`/hy2\\_set\\_port 8443`\n"
            "`/hy2\\_gen\\_all`  — авто insecure\\=1\n"
            "`/hy2\\_on`\n"
            "`/hy2\\_add\\_client phone`\n"
            "`/hy2\\_apply`\n"
            "`/hy2\\_start`\n"
            "`/hy2\\_qr phone`\n\n"
            "*3\\. TUIC \\(QUIC\\)*\n"
            "`/tuic\\_set\\_server IP`\n"
            "`/tuic\\_set\\_port 8444`\n"
            "`/tuic\\_gen\\_all`\n"
            "`/tuic\\_on`\n"
            "`/tuic\\_apply`\n"
            "`/tuic\\_start`\n"
            "`/tuic\\_qr phone`\n\n"
            "*4\\. AnyTLS*\n"
            "`/anytls\\_set\\_server IP`\n"
            "`/anytls\\_set\\_port 8445`\n"
            "`/anytls\\_gen\\_all`\n"
            "`/anytls\\_on`\n"
            "`/anytls\\_apply`\n"
            "`/anytls\\_start`\n"
            "`/anytls\\_qr phone`\n\n"
            "*5\\. XHTTP \\(VLESS\\+XHTTP\\)*\n"
            "`/xhttp\\_set\\_server IP`\n"
            "`/xhttp\\_set\\_port 8446`\n"
            "`/xhttp\\_gen\\_all`\n"
            "`/xhttp\\_on`\n"
            "`/xhttp\\_apply`\n"
            "`/xhttp\\_start`\n"
            ...
            "*6\\. NaiveProxy \\(Caddy\\)*\n"
            "`/naive\\_install`\n"
            "`/naive\\_set\\_domain example.com`\n"
            "`/naive\\_set\\_port 443`\n"
            "`/naive\\_gen\\_creds`\n"
            "`/naive\\_on`\n"
            "`/naive\\_apply`\n"
            "`/naive\\_uri`\n\n"
            "*7\\. MTProto \\(Telegram proxy\\)*\n"
            "`/mt\\_install`\n"
            "`/mt\\_set\\_server IP`\n"
            "`/mt\\_set\\_port 8443`\n"
            "`/mt\\_gen\\_all`\n"
            ...
            "`/mt\\_qr phone`\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "💡 После каждого протокола проверяйте:\n"
            "`/PROTO\\_status` и `/PROTO\\_logs`"
        ),
        "help_admin": (
        ...
        "help_vless": (
            ...
            "`/vless\\_qr phone`\n"
            "Или вручную:\n"
            "`/vless\\_gen\\_keys` → `/vless\\_set\\_port 443`\n"
            "→ `/vless\\_on` → `/vless\\_add\\_client phone`\n"
            "→ `/vless\\_export` → `/vless\\_qr phone`\n\n"
            "━━ 📋 Команды ━━\n"
            ...
            "━━ 🔍 Диагностика ━━\n"
            "`/vless\\_status` — состояние протокола\n"
            "`/vless\\_test` — тест подключения\n"
            "`/xray\\_status` — статус Xray сервиса\n"
            "`/xray\\_config` — текущий конфиг\n\n"
            "⚠️ _Если клиент не подключается:_\n"
            "1\\. `/vless\\_status` — enabled\\?\n"
            "2\\. `/xray\\_status` — running\\?\n"
            "3\\. `/vless\\_test` — порт открыт\\?\n"
            "4\\. Проверьте firewall: `ufw allow 443`"
        ),
        "help_hy2": (
            "⚡ *Hysteria2*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "`/hy2\\_set\\_port 8443`\n"
            "`/hy2\\_gen\\_all`  — авто insecure\\=1\n"
            "`/hy2\\_set\\_insecure 1`  — если gen\\_all был ранее\n"
            "`/hy2\\_on`\n"
            "`/hy2\\_add\\_client phone`\n"
            "`/hy2\\_apply`\n"
            "`/hy2\\_start`\n"
            ...
            "/hy2\\_export \\- Экспорт\n\n"
            "━━ 🔍 Диагностика ━━\n"
            "`/hy2\\_status` — состояние конфига\n"
            "`/hy2\\_logs` — логи сервиса\n"
            "`/hy2\\_list\\_clients` — список клиентов\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. `Permission denied` — запустите бот с root\n"
            "2\\. `systemctl not found` — нужен `pid: host`\n"
            "3\\. Порт занят — `/hy2\\_set\\_port ДРУГОЙ`\n"
            "4\\. Нет сертификата — `/hy2\\_gen\\_cert`\n"
            "5\\. Firewall: `ufw allow 8443/udp`"
        ),
        "help_tuic": (
            "🔷 *TUIC*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "━━ 🔍 Диагностика ━━\n"
            "`/tuic\\_status` — состояние конфига\n"
            "`/tuic\\_logs` — логи сервиса\n"
            "`/tuic\\_list` — список клиентов\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. Порт занят — `/tuic\\_set\\_port ДРУГОЙ`\n"
            "2\\. Нет сертификата — `/tuic\\_gen\\_cert`\n"
            "3\\. Firewall: `ufw allow 8444/udp`"
        ),
        "help_anytls": (
            "🔶 *AnyTLS*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "━━ 🔍 Диагностика ━━\n"
            "`/anytls\\_status` — состояние конфига\n"
            "`/anytls\\_logs` — логи сервиса\n"
            "`/anytls\\_list` — список клиентов\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. Порт занят — `/anytls\\_set\\_port ДРУГОЙ`\n"
            "2\\. Нет сертификата — `/anytls\\_gen\\_cert`\n"
            "3\\. Firewall: `ufw allow 8445/tcp`"
        ),
        "help_xhttp": (
            "🌐 *XHTTP \\(VLESS\\+XHTTP\\)*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "━━ 🔍 Диагностика ━━\n"
            "`/xhttp\\_status` — состояние конфига\n"
            "`/xhttp\\_logs` — логи сервиса\n"
            "`/xhttp\\_list` — список клиентов\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. Порт занят — `/xhttp\\_set\\_port ДРУГОЙ`\n"
            "2\\. Нет сертификата — `/xhttp\\_gen\\_cert`\n"
            "3\\. Path конфликт — `/xhttp\\_set\\_path /new`\n"
            "4\\. Firewall: `ufw allow 8446/tcp`"
        ),
        "help_naive": (
            "🌐 *NaiveProxy*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "━━ 🔍 Диагностика ━━\n"
            "`/naive\\_status` — состояние конфига\n"
            "`/naive\\_uri` — текущий URI\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. Домен не указывает на IP — проверьте DNS\n"
            "2\\. Порт 443 занят — остановите другой TLS\n"
            "3\\. Caddy не установлен — `/naive\\_install`"
        ),
        "help_mt": (
            "📡 *MTProto Proxy*\n\n"
            "━━ 🗺 Быстрый старт ━━\n"
            ...
            "/mt\\_export \\- Экспорт\n\n"
            "━━ 🔍 Диагностика ━━\n"
            "`/mt\\_status` — состояние конфига\n"
            "`/mt\\_logs` — логи сервиса\n"
            "`/mt\\_list\\_clients` — список клиентов\n\n"
            "⚠️ _Типовые ошибки:_\n"
            "1\\. `mtg` не найден — `/mt\\_install`\n"
            "2\\. Порт занят — `/mt\\_set\\_port ДРУГОЙ`\n"
            "3\\. Firewall: `ufw allow 8443/tcp`"
        ),
        "help_tgcapsule": (
            "🧭 *TelegramOnly Export:*\n\n"
...
*Обновлено:* {esc(status.get("updated_at", "никогда"))}"""
    ...
    async def hy2_set_insecure(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            if not args or args[0] not in ("0", "1"):
                await update.message.reply_text("Использование: /hy2_set_insecure 1  или  /hy2_set_insecure 0")
                return
            insecure = args[0] == "1"
